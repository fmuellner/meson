...
def install_help(srcdir, blddir, sources, media, langs, install_dir, destdir, project_id):
    for lang in langs + ['C']:
...
def run(args):
    ...
    if options.command == 'pot':
        ...
        install_help(src_subdir, build_subdir, sources, media, langs, install_dir, destdir, options.project_id)
